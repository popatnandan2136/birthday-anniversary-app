...
export const WishPage = () => {
  ...
  const loadWish = async () => {
    setLoading(true);
    try {
      const data = await getWishBySlug(slug);
      if (!data) {
        showError('Wish not found or has been deactivated');
        setWish(null);
      } else {
        setWish(data);
      }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 to-purple-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">This wish is not available or has been deactivated.</p>
          <a
            href="/"
